            ...
            <div id="sidebar-menu" class="main_menu_side hidden-print main_menu">
              <div class="menu_section">
                ...
                <ul class="nav side-menu">
                  ...
                  <li><a href="{{ url('/photos')}}"><i class="fa fa-camera"></i> Photo News </a>
                  </li>
                  <li><a href="{{ url('/videos')}}"><i class="fa fa-video-camera"></i> Video News </a>
                  </li>
                  @foreach(App\Category::orderBy('priority', 'desc')->cursor() as $cat)
                  <li><a href="{{ url('/category/'.$cat->id) }}"><i class="{{$cat->icon}}"></i> {{$cat->name}} </a></li>
                  @endforeach                    
              ...
              @else
                <li class="">
                  <a href="javascript:;" class="user-profile dropdown-toggle" data-toggle="dropdown" aria-expanded="false">
                    <img src="{{Auth::user()->picture == NULL ? asset('images/uploads/users/default2.png') :asset('images/uploads/'.Auth::user()->picture) }}" alt="">{{Auth::user()->name}}
                    <span class=" fa fa-angle-down"></span>
                  </a>
                  <ul class="dropdown-menu dropdown-usermenu pull-right">
                    <li><a href="{{url('/user/' . Request::user()->id)}}"> Profile</a></li>
                    <li>
                      <a href="javascript:;">
                    ...
                    <li><a href="{{ url('/editpersonal/changepassword') }}"> Change Password</a></li>
                    <li>
                    <a href="{{ url('/logout') }}"

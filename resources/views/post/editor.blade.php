<div class="btn-toolbar" data-role="editor-toolbar" data-target="#editor">
      ...
      <!--<input type="text" data-edit="inserttext" id="voiceBtn" x-webkit-speech="">-->
                                  ...
                                  @if(isset($body))
                                <div id="editor" class="form-control"  rows="10" placeholder="Body for your Article goes here" required>{!!html_entity_decode($body)!!}</div>
                                @else
                                  <div id="editor" class="form-control"  rows="10" placeholder="Body for your Article goes here" required></div>
                                @endif
                                @if ($errors->has('body'))

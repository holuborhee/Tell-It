...
<div class="page-header">
            ...
            <h3><i class="fa fa-video-camera" ></i> Video Reports <span class="label label-info">{{App\Post::where('type','Video')->count()}}</span></h3>
            
            <a href="{{url('/videos/create')}}" class="btn btn-success pull-right" 
                               >
        ...
        <div class="row">
            ...
            <div class="panel panel-success content-box">
                <div class="panel-heading">
                    <h3 class="panel-title">All Posts <span class="label label-warning">0</span>
                ...
                @foreach($posts as $post)
                    <div class="newsfeed videonews" id="mn">
                        <h2>{{$post->post->title}}.</h2> 
                              <video controls <!--autoplay-->>
                                  <source src="{{url($post->url)}}" type="video/mp4">
                              </video>
                            <mark>{{$post->post->created_at}}</mark>
                    </div>

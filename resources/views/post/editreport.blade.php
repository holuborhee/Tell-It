...
<div class="col-xs-12">
                    ...
                    <form class="form-horizontal" role="form" method="POST" action="{{ url('/report/' . $id) }}">
                        {{ csrf_field() }}
                        {{ method_field('PUT') }}
                        @if(isset($id))
  ...
  <div class="form-group{{ $errors->has('title') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-12">
                                <input id="title" type="text" class="form-control" name="title" value="{{ App\TextPost::findOrFail($id) ?App\TextPost::findOrFail($id)->post->title:old('title') }}" placeholder="Descriptive Title For Article" required autofocus>
    ...
    <div class="form-group{{ $errors->has('lead') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-12">
                                <textarea id="lead" class="form-control" name="lead" rows="4" placeholder="Article Lead here" required>{{ App\TextPost::findOrFail($id) ?App\TextPost::findOrFail($id)->post->lead:old('lead') }}</textarea>
                                @if ($errors->has('lead'))
                                    <span class="help-block">
